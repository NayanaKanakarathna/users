            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}" id="birthday_div" style="display: none;">
                        ...
                        <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}" id="department_div" style="display: none;">
